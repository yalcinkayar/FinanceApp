...
@section('content')
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Collection Operation</h6>
        </div>
        <!-- /.page-title-left -->
        <div class="page-title-right d-none d-sm-inline-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Collection Operation</li>
            </ol>
            <div class="d-none d-md-inline-flex justify-center align-items-center"><a href="javascript: void(0);" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple" target="_blank">Add New Collection Operation</a>
            </div>
        </div>
        <!-- /.page-title-right -->
    </div>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <form action="{{ route('operations.store',['type'=>1]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="billingid" class="m-b-10 form-control billing" data-placeholder="Select Billing" data-toggle="select2">
                                            ...
                                            @foreach(\App\Billing::getList(BILLING_INCOMING) as $k => $v)
