...
@section('content')
    <div class="row page-title clearfix">
        ...
        <div class="page-title-right d-none d-sm-inline-flex">
            ...
            <div class="d-none d-md-inline-flex justify-center align-items-center"><a href="javascript: void(0);" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple" target="_blank">Add New Outgoing Billing</a>
            </div>
        </div>
        <!-- /.page-title-right -->
    </div>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <form action="{{ route('billing.store',['type'=>1]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
