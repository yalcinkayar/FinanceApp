...
@section('content')
    <div class="row page-title clearfix">
        ...
        <div class="page-title-right d-none d-sm-inline-flex">
            ...
            <div class="d-none d-md-inline-flex justify-center align-items-center"><a href="javascript: void(0);" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple" target="_blank">Add New Product</a>
            </div>
        </div>
        <!-- /.page-title-right -->
    </div>
                ...
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row product--area">
                                <div class="col-md-12">
                                    <label class="col-form-label" for="l0">Product Name</label>
                                    <input class="form-control" required name="productName"  type="text">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" required name="purchasePrice"  type="text">
                                </div>
                                <div class="col-md-6">
                                    <label class="col-form-label" for="">Sale Price</label>
                                    <input class="form-control" required name="salePrice"  type="text">
                                </div>
                            </div>
